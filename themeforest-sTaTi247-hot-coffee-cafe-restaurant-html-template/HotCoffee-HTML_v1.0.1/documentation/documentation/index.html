...
<head>
	...
	<title>Hotcoffee Documentation v1.5</title>
	...
	<div id="header" class="navbar navbar-inverse " role="navigation">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="http://hotcoffee-html.themerex.net/" target="_blank">Hotcoffee</a>
		...
		<div class="doc-container row clearfix">
			...
			<div class="doc-content col-md-9">
				...
				<div class="docs-section" id="gt_strt">
					...
					<h3>Introduction</h3>
					<p>
						Thank you for purchasing our template. We are happy that you are one of our customers and we assure you
                        won't be disappointed. We do our best to produce top notch templates with great functionality,
                        premium designs and human readable code.
                    </p>
					<p>
						<b>Hotcoffee</b> is a responsive and clean HTML template, made by a team of creative professionals here at ThemeREX.
						<a href="http://themeforest.net/user/ThemeREX/portfolio" target="_blank">ThemeREX</a> is a place to buy premium WordPress themes and HTML templates covered by effective and helpful support. Creative, crazy about details and innovative. We are a small and customers oriented company aiming to exceed your expectations!
					</p>
					...
					<p>
						<span class="label label-info">DO NOT FORGET</span>
						to rate this template on <a href="http://themeforest.net/user/ThemeREX/portfolio" target="_blank">ThemeForest</a> – it's good to know what others think about our work. You can rate it in the download area of your account:
					</p>
					<div class="image-box">
					...
					<p>
						With ThemeForest regular license you are licensed to use this template to create one single End Product (the final website customized with your content) for yourself or one client. In short:
					</p>
					...
					<p><b>What is allowed with single regular license:</b><br>
						<ol>	
							...
							<li>
								You can install the template on your test server for testing/development purposes
								(that installation shouldn't be available to the public).
							</li>
							<li>
								You can modify or manipulate the template, you can combine it with other works to
					...
					<p><b>What is not allowed:</b><br>
						...
						<ul>
							<li>License FAQ: <a href="http://themeforest.net/licenses/faq" target="_blank">http://themeforest.net/licenses/faq</a></li>
							<li>Licenses overview: <a href="http://themeforest.net/licenses" target="_blank">http://themeforest.net/licenses</a></li>
							<li>Regular license details: <a href="http://themeforest.net/licenses/regular" target="_blank">http://themeforest.net/licenses/regular</a></li>
							<li>Extended license details: <a href="http://themeforest.net/licenses/extended" target="_blank">http://themeforest.net/licenses/extended</a></li>
						</ul>
					</p>
					...
					<h4>Support Policy</h4>
	                    ...
	                    <p>
	                    	To be able to request a technical support assistance, you need to have a valid purchase code. To get the code, please navigate to your Themeforest "Download" page and click on the template download link.<br>      
    						Check this link for more information on this matter: <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-</a>.
	                    </p>

						<p>
							<span class="label label-info">PLEASE NOTE</span><!-- <span class="label label-danger">IMPORTANT!</span> --> That as authors of this template we do provide support only for the template-related features and of course for the issues related strictly to this template.<br> 
						...
						<p>
							If you have any questions that are beyond the scope of this help file, feel free to post them on our support message board (forum) at <a href="https://themerex.ticksy.com" target="_blank">https://themerex.ticksy.com</a>. We will respond as soon as possible (within 24 – 48 hours, usually faster).
							<b>We are open from 10am to 7pm (CET), from Monday till Friday.</b> 
	                    </p>
                    ...
                    <p>
                    	...
                    	All you need to do is follow this link <a href="http://support.mockingbird-studio.com/" target="_blank">http://support.mockingbird-studio.com/</a> and submit a ticket with detailed explanations of what needs to be done.
                    </p>
					<!-- <div class="image-box">
						<a href="http://support.mockingbird-studio.com/" target="_blank"> 
                    ...
                    <p>
						...
						<ul>
							<li><a href="http://getfirebug.com/video/Intro2FB.htm" target="_blank">http://getfirebug.com/video/Intro2FB.htm</a></li>
							<li><a href="https://css-tricks.com/video-screencasts/15-introduction-to-firebug/" target="_blank">https://css-tricks.com/video-screencasts/15-introduction-to-firebug/</a></li>
						</ul>
                    </p>
                    ...
                    <p>Here you can find more information about CSS:
                    	<ul>
                    		<li><a href="https://developer.mozilla.org/en-US/learn/css" target="_blank">https://developer.mozilla.org/en-US/learn/css</a></li>
                    		<li><a href="http://www.w3schools.com/css/" target="_blank">http://www.w3schools.com/css/</a></li>
                    		<li><a href="http://reference.sitepoint.com/css/syntax" target="_blank">http://reference.sitepoint.com/css/syntax</a></li>
                    	</ul>
                    </p>
				...
				<!-- DO NOT FORGET TO UNCOMMENT THIS SECTION DIV (489), IF NEEDED -->
				...
				<!-- <div class="docs-section" id="customizer">
					...
					<p>
                        Files responsible for the output, styles and settings of the panel:<br><br>

                        <code>root directory.../css/core.customizer.css</code>
                        <br><br>

                        <code>root directory.../images/switcher/...</code>
                        <br><br>

                        <code>root directory.../js/core.customizer/...</code>
                    </p>
					...
					<div class="spoil">
						<div class="sp_top">
							<span class="sp_span">Code</span>
							<button class="sp_button">Show</button>
						</div>
						<div class="sp_text">
							<pre class="prettyprint linenums">
&lt;script type=&quot;text/javascript&quot; src=&quot;js/core.customizer/front.customizer.js&quot;&gt;&lt;/script&gt;</pre>
						</div>
					</div>

					<p>
						<span class="label label-info">PLEASE NOTE!</span>
						Changes made via Customizer panel stays active until you refresh the page. To save the changes you would need to edit the source files. This "on-the-go" customization functionality is for demonstration purposes only.
					</p> -->
...
&lt;body class=&quot;home page fullscreen top_panel_above boxed openMenuFixRight bg_image_1&quot;&gt;</pre>
					...
					<!-- DO NOT FORGET TO UNCOMMENT THIS DIV, IF NEEDED -->
				...
				<div class="docs-section" id="homepage">
					...
					<!-- <p>
						Skin Example Page (.index.html):
					</p>

					<div class="image-box">
						<a href="images/index.png" rel="prettyPhoto" title="">
					...
					<div class="image-box">
						<a href="images/home_3.png" rel="prettyPhoto" title="">
					...
					<div class="image-box">
						<a href="images/home_4.png" rel="prettyPhoto" title="">
							<img src="images/home_4.png" alt="">
						</a>		
					</div> -->

					<p>
							The corresponding file <code>index.html</code><!-- , <code>home-2.html</code>, <code>home-3.html</code> --><!-- , <code>index-4.html</code> --> (as well as the others .html-related ones) are in the root directory of your template's archive.
					</p>
...
&lt;/div&gt;</pre>
					...
					<p>The corresponding file, which is <code>single-post.html</code> is in the root directory of your template's archive.</p>
...
&lt;/div&gt;</pre>
					...
					<p>The corresponding file, which is <code>post-single.html</code> is in the root directory of your template's archive.</p>
				...
				<!-- <div class="docs-section" id="prtfl">
					...
					<p>
                        The example(s) of portfolio-like type structure can be seen on "All Property" page.<br>
                    ...
                    <p>
                        The snippet below belongs to the "All Property" page: <code>root directory.../property-blog.html</code>.
                    </p>

					
					<div class="spoil">
						<div class="sp_top">
							<span class="sp_span">Isotope Code</span>
							<button class="sp_button">Show</button>
						</div>
						<div class="sp_text">
							<pre class="prettyprint linenums">
&lt;div class=&quot;main_isotope isotope_wrap inited&quot; style=&quot;position: relative; height: 806.062px;&quot;&gt;
&lt;/div&gt;</pre>
						</div>
					</div>
                    ...
                    <p>
                        Please note that filtration in portfolio block works only if an element contains filtering class, for example <b>isotope_item isotope_item_property isotope_item_property_3 isotope_column_3 isotope_item_show</b>.
                    </p>
                    <p>
                        File(s) responsible for the Isotope script:<br><br>
                         
                        <code>root directory.../js/isotope.pkgd.min.js</code><br><br>

                        <code>root directory.../js/_main.js</code><br><br>

                        <code>root directory.../js/vendor/jquery.isotope.min.js</code>
                    </p>

                    <p>
                    	Isotope Script is also responsible for ajax blocks loading from html files at <code>root directory.../ajax/...</code> directory. This script is in the <code>root directory.../js/custom/_front.js</code> file. Check the screenshot below for more information.
                    </p>
				...
				<div class="docs-section" id="soc_ic">
					...
					<div class="spoil">
						...
						<div class="sp_text">
							<pre class="prettyprint linenums">
&lt;li class=&quot;icon-facebook&quot;&gt;&lt;a href=&quot;#&quot;&gt;Facebook&lt;/a&gt;&lt;/li&gt;</pre>
							</div>
					</div>
				...
				<div class="docs-section" id="tpgr">
					...
					<h3>Dropcaps</h3>
					<div class="image-box">
						<a href="images/dropcaps_fb.png" rel="prettyPhoto" title="">
							<img src="images/dropcaps_fb.png" alt="">
						</a>		
					</div>

					<p>
						Check the <code>typography.html</code> file for more information.
					</p>
				...
				<div class="docs-section" id="shrtc">
					...
					<p>Below is an example of shortcode available with this template.</p>
...
&lt;span class=&quot;sc_highlight sc_highlight_style_1&quot;&gt;accusantium doloremque&lt;/span&gt;</pre>
					...
					<p>
                        File(s) responsible for <!-- both (the one on the slider and the other one on the Contact Us page) --> contact form functionality:<br><br>

                        <code>root directory.../include/sendmail.php</code>
                        <br><br>

                        <!-- <code>root directory.../js/custom/_form_contact.js</code>
                        <br><br> -->

                        <code>root directory.../contacts.html</code>

                        <!-- <code>root directory.../js/custom/__main.js</code> -->
                        <!-- <br><br>
                        <code>root directory.../include/contact-form.php</code>
                        <br><br>
                        <code>root directory.../js/custom/_form_contact.js</code> -->
                        <!-- <code>root directory.../js/_form_contact.js</code>  -->

                    </p>
                    <p>
                        Specify your email address in the <code>sendmail.php</code> file. Check the screenshot below.
                    </p>
                    ...
                    <div class="spoil">
						...
						<div class="sp_text">
							<pre class="prettyprint linenums">
$contact_email = 'user@example.com';</pre>
						</div>
					</div>
					...
					<p>
                        File(s) responsible for Google map initialization and functionality:<br><br>
                        
                        <code>root directory.../js/custom/_form_contact.js</code><br><br>

                        <code>root directory.../js/vendor/core.googlemap.js</code><br><br>
                    ...
                    <p>
                        Specify the address/coordinates in the <code>root directory.../contacts.html</code> file or any .html related one where the Google map should appear.
                    </p>

                    
					<div class="spoil">
						<div class="sp_top">
							<span class="sp_span">Address's Code</span>
							<button class="sp_button">Show</button>
						</div>
						<div class="sp_text">
							<pre class="prettyprint linenums">
...
&lt;/div&gt;</pre>
					...
					<p>Specify the Google API Key in any file you want Google Map to appear. Insert it right after the "key=" attribute. Check the screenshot below for more information. </p>

					<div class="spoil">
						<div class="sp_top">
							<span class="sp_span">API's key code</span>
							<button class="sp_button">Show</button>
						</div>
						<div class="sp_text">
							<pre class="prettyprint linenums">
&lt;script type=&#39;text/javascript&#39; src=&#39;http://maps.googleapis.com/maps/api/js?key=&#39;&gt;&lt;/script&gt;</pre>
						</div>
					</div>


					<div class="image-box">
						<a href="images/map_api_sublime.png" rel="prettyPhoto" title="">
							<img src="images/map_api_sublime.png" alt="">
						</a>		
					</div>
				...
				<div class="docs-section" id="addtnl_plgns">
					...
					<p>
						Several additional plugins were stylized according to the main color scheme of this template. In this section, we describe a few of them.<br>
                        As for the rest, all the necessary files are in the <code>root directory.../js/...</code> and <code>root directory.../css/...</code> folder(s).
					</p>

					<p>
						<span class="label label-info">PLEASE NOTE!</span>
						Full-fledged functionality might not be supported/provided for some of the additional plugins (because some of them were just stylized to match the template's color scheme and overall look) as it is just an HTML template.
					</p>

					<p>Below you can check a brief explanations to some of the most popular plugins included into this template.</p>
                    ...
                    <p>
                        ...
                        <!-- <code>root directory.../js/custom/...</code><br><br> -->

                        <code>root directory.../js/vendor/revslider/...</code><br><br>

                        
                        <!-- <code>root directory.../js/_main.js</code><br><br>  -->

                        <!-- <code>root directory.../js/revslider-homepage-2.js</code><br><br>   -->

                        <!-- <code>root directory.../css/revslider.css</code><br><br>

                        <code>root directory.../js/revslider-homepage.js</code> -->
                    ...
                    <p>
                        Check the <code>index.html</code> file <!-- (as well as the other corresponding index files) --> for more information. 
                    </p>
					...
					<p>
                        File(s) responsible for the Swiper Slider functionality:<br><br>
                        <!-- <code>root directory.../js/_packed.js</code><br><br>  -->

                        <code>root directory.../js/vendor/swiper/...</code><br><br> 

                        <!-- <code>root directory.../css/swiper.min.css</code><br><br> -->

                        <code>root directory.../shortcodes.html</code>
                    </p>

                    <p>
                        Check the <code>shortcodes.html</code> file for more information.
                    </p>
				...
				<div class="docs-section" id="src_crdts">
                    ...
                    <p>In this section you can find an additional information regarding fonts and clipart (.psd files) used in this template.</p>
                    <ul>
                        <li>
                            Fonts:<br><br>
                            <ul>
                                <li>Check the <code>root directory.../css/...</code><!--  and <code>root directory.../css/font-face/</code> --> folder for more information.</li>
                                
                                <li>Fontello (non standard, icons set). Specified in every <code>.html</code> file. Check this directory for more information <code>root directory/css/fontello/...</code>.</li>
                            </ul>
                        </li>
                        <br>
                        ...
                        <li>
                            Clipart:<br><br>
                            <ul>
                                <li>Images were taken from <a href="http://www.depositphotos.com/" target="_blank">here</a>.</li>
                                <br>

		                    	<li>
		                    		<span class="label label-danger">IMPORTANT!</span>
		                        	Please be aware that all clipart images included in this template are the copyrighted to their respective owners and are not available for download with this template. Clipart images can not be used without express permission from the owner and/or need to be purchased separately.<br>
		                        	Nevertheless, you can request the image IDs/references by contacting our <a href="https://themerex.ticksy.com/" target="_blank">support department</a>.
		                        </li>
                            </ul>
                        </li>
                        <br>
                        <li>
                            PSD Files:<br><br>
                            <ul>
                                <li> Please be aware that <b style="color:red">we do not include</b> template-related <b style="color:red">.PSD files</b> in the template package, because it might significantly increase the size of a downloadable archive.<br>
        						In case you need these files you can always request them by contacting our support department at <a href="https://themerex.ticksy.com/" target="_blank">https://themerex.ticksy.com/</a>.</li>
                            </ul>
                        </li>
                    </ul>
				...
				<div class="docs-section" id="trblsht">
                    ...
                    <p>
                        ...
                        <p>
                            ...
                            Unfortunately, we do not provide support for installation, any customizations or 3rd party plugins. You also need to have a <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">valid purchase key</a> to request an assistance from our support team.<br> 
                            
                        </p>

                        <!-- <p><b><a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">How to find a purchase key </a>:</b>
                        </p>
                        <ul>
	...
	<div class="footer-wrapper">
		<footer class="container clearfix">
			<p><a href="http://themeforest.net/user/ThemeREX/portfolio">ThemeREX © 2017</a> All Rights Reserved
